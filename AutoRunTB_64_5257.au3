...
Global $TBloginName		=	"wkjy90580068"
Global $TBloginPassword	=	"Dyang999"
Global $TBInstallPath	=	"C:\Users\Administrator\Documents\tbv5257_x64_portable"
...
Func TBLogin()
        If WinExists("暂停自动登录交易帐户") = 0 Then 	;动作前提条件
                ...
                ControlFocus("","暂停自动登录交易帐户","Edit1")
                ControlSetText("","暂停自动登录交易帐户","Edit1", $TBloginName)
...
;动作编号20：重启系统
Func ShutdownR()
        Filewriteline($LogName, "20:" & @TAB & $LogTime & "周日未重启系统")
        ;Run("shutdown -r")
EndFunc
